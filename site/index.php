...
?>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-3">
            <?php foreach($animais as $codigo => $animal): ?>
              <div class="col">
                    <div class="card">
                        <img width=300px height=200px src="../uploads/<?php echo $animal->foto; ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h3 class="card-title"><?php echo $animal->nomedoanimal ?></h3>
                            <a href="ler.php?id=<?php echo $animal->codigo; ?>" class="btn btn-primary"> Ver mais</a>
                        </div>
                    </div>
                    </div>
            <?php endforeach; ?>
